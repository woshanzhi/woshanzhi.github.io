---
layout: post
title: "论文图片格式与深度学习结构图绘制经验总结"
date: 2026-07-08
tags: [scientific, academic paper]
toc: true
comments: true
author: 日暮秋烟起
---

目前先记录我在写论文、做汇报、整理科研材料时，关于**论文图片格式与深度学习结构图绘制**的经验总结。这篇博客也会持续更新相关内容：
...
你可以找一些转ppt的网站或者工具进行细微更改
实验生成图尽量生成pdf，这里提供一个工具https://www.ilovepdf.com/ 这个可以进行相关文件转换
---
...
如果你准备长期做深度学习相关研究，建议把常见模块整理成自己的模板。这样以后画新网络时，只需要改结构参数，不用每次从头写。
...
## 十、豆包：
豆包生成图像的功能很强大
可以给出指令让画出大致，自己根据理解来完善修改，这对于理工男来说很方便
